export default function EnvelopeBudgetPrivacy() {
  return (
    ...
    <div style={{ maxWidth: 800, margin: '0 auto', padding: '40px 24px', fontFamily: 'sans-serif', color: 'rgba(255, 255, 255, 0.87)', lineHeight: 1.7 }}>
      <h1>Privacy Policy — Envelope Budget</h1>
      <p><strong>Effective Date:</strong> {new Date().toLocaleDateString('en-US', { year: 'numeric', month: 'long', day: 'numeric' })}</p>

      <p>
        This Privacy Policy describes how <strong>Envelope Budget</strong> ("the App") handles your information.
        The App is a simple envelope-style budgeting tool that helps you create expense categories, track
        spending, and manage your monthly budget entirely on your device.
      </p>

      <h2>1. Information We Collect</h2>
      <p>
        <strong>Envelope Budget does not collect, store, or transmit any personal information to external servers.</strong> The App
      ...
      <p>
        All envelopes, budgets, and spending data you create within the App are stored locally on your device only.
